...
class News(models.Model):
    ...
    NEWS_IMAGE = models.ImageField(upload_to="Uploads/News/", null=True, blank=True)
    NEWS_DESCRIPTION = models.TextField()
    NEWS_CREATED_BY = models.ForeignKey(EmployeeSetup, on_delete=models.PROTECT, related_name="NEWS_CREATED_BY", null=True, blank=True)
    NEWS_MODIFIED_BY = models.ForeignKey(EmployeeSetup, on_delete=models.PROTECT, related_name="NEWS_MODIFIED_BY", null=True, blank=True)
